  ...
  const renderHeader = () => (
    <div className="sticky top-0 z-10 bg-background/80 backdrop-blur-sm border-b border-border">
      <div className="flex items-center justify-between p-4 md:p-6 max-w-6xl mx-auto">
        {/* Mobile Header Layout: [Brand][Search][Hamburger] */}
          ...
          <div className="relative flex-1 max-w-[60%]">
            ...
            {searchState === 'results' && filteredBooks.length === 0 && searchQuery.trim() !== '' && (
              <div className="absolute top-full left-0 right-0 mt-1 bg-card border border-border rounded-lg shadow-lg z-50 p-3">
                <p className="text-muted-foreground text-center text-xs">No books found</p>
              </div>
            )}
          </div>
        </div>

        {/* Desktop/Tablet Header Layout (unchanged) */}
